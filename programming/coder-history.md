...
- 프레임워크 시대: Spring (2003), Ruby on Rails (2004), Django (2005). 웹 애플리케이션의 뼈대를 프레임워크가 제공하고, 개발자는 업무 로직만 채웠다. 한국은 2000년대 후반까지 Struts나 JSP에 직접 JDBC가 많았고, 2009년 전자정부 표준프레임워크가 스프링 기반으로 나오면서 공공 SI 전체가 스프링으로 갔다. 이후 2010년대 한국은 스프링+MyBatis가 거의 독점했다.
