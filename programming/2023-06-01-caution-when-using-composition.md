...
5. OOP 관점에서 문제를 해결하는 방법은, 문제 공간의 개념을 객체로 모델링하고, 원하는 대로 동작하도록 배열하는것. 이를 위해서 객체는 서로 동등해야되는데 예고르는 그걸 [잘 못 됬다고](https://github.com/juniqlim/note/blob/master/programming/alan/2023-06-01-alan-say-about-alan-kay-was-wrong-about-him-being-wrong.md) 함. 그는 OO의 근본 개념인 decomposition에 반대하고 있는 것.
