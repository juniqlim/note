...
라는 것이 [이너게임 책](https://www.yes24.com/product/goods/1941471)의 핵심 내용이다.
...
[뽀모도로 기법](https://github.com/juniqlim/note/blob/master/programming/pomodoro-retrospective.md)에도 접목해 보았다. 매 사이클 마다 내 감정을 노트에 적었다. 적고 나면 그 감정이 작아졌다. 다음 사이클에서 더 집중할 수 있었다.  

머릿속에서 잘 안풀리는 문제에 대해서도, 간단히 노트에 적고 나면 신기하게 아이디어가 떠올랐다.

## 두 가지 사고 모드
[실용주의 사고와 학습 책](https://wikibook.co.kr/pragmatic-thinking-and-learning/)에 따르면 우리 뇌는 [L모드(선형적), R모드(풍부한)](https://toolshed.com/articles/2015-01-29-LRModeDMN.html)로 구분된다.  
