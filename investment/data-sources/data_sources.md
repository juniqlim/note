...
## 6. 와이낫셀리포트 (whynotsellreport.com)
...
```bash
# 채널 목록 조회
python data-sources/telegram/info.py

# 키워드 검색
python data-sources/telegram/search.py 코스맥스
python data-sources/telegram/search.py 코스맥스 실리콘투 -n 10 -o result.txt
```
