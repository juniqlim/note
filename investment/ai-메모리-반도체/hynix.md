...
| 시가총액 | ~580조 | ~915조 |
| PER | 18배 | 32배 |
| **Forward PER (2026)** | **~8배** | **~10배** |
| 2026 영업이익 | ~100~115조 | ~100조 |
| HBM 점유율 | **57~62% (1위)** | 22% (3위) |
| 사업 집중도 | 메모리 올인 | 분산 (반도체+스마트폰+가전) |
...
### SK하이닉스 매출 추이 (2013~2025)

| 연도 | 매출(USD) | 매출(원) | 전년비 | 구간 |
|------|----------|---------|--------|------|
| 2013 | $13.1B | ~14.5조 | - | |
...
| 2019 | $23.2B | ~27.3조 | **-37%** | 다운사이클 |
| 2020 | $27.4B | ~31.9조 | +18% | 코로나 서버 수요 |
| 2021 | $37.0B | ~43.8조 | +35% | |
| 2022 | $34.4B | ~37.9조 | **-7%** | 다운사이클 |
| 2023 | $24.9B | ~32.8조 | **-28%** | 다운사이클 바닥 |
| 2024 | $48.0B | ~66.2조 | **+93%** | AI/HBM 폭발 |
| 2025 | $59.4B | ~97.1조 | +47% | 사상 최대 |

**12년간 $13B → $59B = 4.5배 성장. 다운사이클 바닥이 점점 높아짐.**

### 다운사이클 원인 분석

3사 과점 이후에도 사이클은 있었다. 하지만 **공급 과잉이 아니라 수요 측 문제**였다.
...
핵심: 3사가 증설을 과잉으로 한 게 아니라, **고객이 미리 너무 많이 사놓고 소화하느라 안 산 것** (수요의 당겨쓰기 후 반동).
...
**패턴 동일**: 앞에서 과다 구매 → 뒤에서 소화 = **pull-forward 후 반동**

### AI 시대 당겨쓰기 리스크

과거 사이클의 교훈: 과점이어도 **수요처가 동시에 쉬면** 사이클 하락은 온다.
...
1. **AI 에이전트 시장은 연다** — 75%가 이미 쓰고, 채택 속도 역사상 최고
2. **투자는 정당하다** — $600B 투자로 $600B+ 시장 창출, 회수 3~6년
3. **추론 시대 최대 수혜 = DRAM(HBM)** — 대체 불가 + 독과점 + 구조적 수요
4. **SK하이닉스 fPER 8배** — 구조적 성장이면 현재 가격은 싸다
