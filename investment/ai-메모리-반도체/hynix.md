...
| SK증권 | 한동희 | 205.1조 | **147.2조** | **150만원** | 2026.01.28 | TP 최고 |
...
**2월 컨센서스 급상향**: 1Q26 메모리 가격 폭등 반영. 송명섭(iM증권) 영업이익 199조원은 극단적 outlier이나, 140조+ 그룹(한동희·류형근·박유악)도 형성.

**실적 전망 3개 그룹** (12개 리포트 분석 기준):
1. 송명섭 199조 (독보적 최고 — DRAM ASP +120%, NAND ASP +146%)
2. 한동희 147조 · 류형근 142조 · 박유악 140조 (140조+ 그룹)
3. 이수림 124조 ~ 김록호 134조 (120~134조 그룹)
...
| | 하단 (1월) | 중앙 | 상단 (2월) | 극단 |
|--|------|------|------|------|
| 매출 | 163조 | ~195조 | 211조 | **259조** (송명섭) |
| 영업이익 | 101조 | ~135조 | **169조** | **199조** (송명섭) |
| OPM | ~60% | ~67% | ~75% | **77%** (송명섭) |

**2월 업데이트**: 1Q26 DRAM 가격 QoQ +100%, 모바일 DRAM +90% 반영으로 상단 대폭 상향. 12개 리포트 중앙값 기준 매출 ~195조, OP ~131조, OPM ~67%.
...
| 모바일 DRAM (LPDDR4X/5X) | **+~90%** |
| Conventional DRAM 전체 | +55~60% |
