...
> 3년간 매출 1,653억 → ~1.1조, 약 6.7배 성장. OPM은 8.6% → 19.9%로 레버리지 효과 확인 후 2025년 소폭 하락 추세.
...
> Q4는 계절적으로 매출·이익 모두 약한 분기. 2024년 Q4 영업이익 급감(426 → 266)은 물류비·마케팅비 집중 투입 영향.
...
| 지표 | 추이 | 비고 |
|------|------|------|
| GPM | 31.9% → 33.7% → 32.3% | 2024 고점 후 하락. 북미 가격 경쟁 영향 |
| OPM | 8.6% → 13.9% → 19.9% → ~18.4% | 규모 레버리지 후 2025 소폭 하락 |

> GPM 하락 원인: 북미 이커머스 할인 경쟁 심화 → 공급가율 조정. 증권가 GPM 가정 35% → 31%로 하향.
...
1. **브랜드 집중 리스크**: 조선미녀 매출 비중 24% (단일 브랜드 의존)
2. **GPM 하락 압력**: 북미 이커머스 경쟁 심화, 대형 유통 채널 확대 시 마진 희석
3. **K-뷰티 트렌드 리스크**: 카테고리 전체가 트렌드에 의존
4. **Q4 계절성**: 매 Q4마다 매출·이익 둔화 패턴 반복
...
> ABW가 성장률은 더 빠르지만 절대 규모는 실리콘투의 1/3~1/5. K-뷰티 시장 자체가 확대 중이라 둘 다 성장하는 구도.
