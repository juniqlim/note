...
## 2Q26 리뷰 (2026-09-21, 반기보고서 8/14)

> 원본: `reports/반기보고서_2026.txt` (rcpNo 20260814001262). 2월 판단 이후 첫 갱신 — 4Q25·1Q26 갱신은 건너뛰었으므로 1H 누적으로 본다.
> 한 줄: **국내는 멈췄고(+1.6%) 해외가 전부를 만든다 — 2월의 "국내 캐시카우 + 해외 엔진" 구도가 반기 만에 "해외 단독 엔진"으로.**

| 항목 (억원) | 2Q26 | 2Q25 | YoY | 1H26 | YoY |
|------|-----:|-----:|----:|-----:|----:|
| 매출 | **1,869** | 1,284 | +45.6% | 3,581 | +47.9% |
| 매출총이익 (GPM) | 1,435 (76.8%) | 995 (77.5%) | +44.2% | 2,750 (76.8%) | |
| 영업이익 | **472** | 292 | **+61.6%** | 923 | +55.7% |
| OPM | **25.3%** | 22.8% | +2.5%p | 25.8% | |
| 순이익 | 381 | 198 | +92% | 744 | +67% |

- 지역 1H26(억원): **한국 989(+1.6%)** / 일본 728(+52.1%) / **미국 503(2.7배)** / 러시아 230(-21.6%) / 기타 1,131(2.3배). **해외 비중 72.4%**(9M25 62%). 2월에 "26F 국내 +7%"로 봤던 캐시카우가 사실상 제로 성장.
- 제품 집중도: 미스트 1,514억(42.4%) + 선케어 907억(25.3%) = **67.7%** — 2025 68.3%에서 거의 그대로. 다변화 진행 없음.
- 3Q25 OPM 14.2% 쇼크는 일시적이었다 — 1H26 25.8%로 상단 복귀. 마케팅 집행 시점 변동성 논리 유지.
- 중국 상해 법인 설립(자본금 미납입, 반기말 미반영). 공장 없음 유지: 유형자산 취득 9.7억.
- 2026 가이던스 6,500~7,000억 대비 1H 3,581 = 51~55% 진행.

**밸류·판정**: 주가 177,800(9/21), 시총 2.22조, PER(1H 순이익 연환산 1,488억) **14.9x**. 보호예수 2026.05·07 해제 통과. 정찰 1주(-22%). 2월 Bull 2번(온라인→오프라인 공식 재현: 미국 2.7배)과 Bear 1번(제품 집중 68%)이 동시에 그대로 진행 중이고, 새 사실은 **국내 정체**다. 다음 확인: 3Q 미국 오프라인(코스트코·ULTA) B2B 비중 → 일본식 마진 개선 경로 진입 여부.
