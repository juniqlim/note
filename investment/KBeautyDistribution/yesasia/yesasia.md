...
- 조직개편 **일회성 퇴직비용 $1.2M이 이미 반영**된 수치. 제외 시 순이익 ~$19.5M, NPM ~6.5%.
...
"규모가 커져서 %가 낮아졌다"는 흔한 반론을 **절대 증가액**으로 검증.
...
**"둘 다 잘 됐다"는 산술적으로 불가능.** B2C가 하던 대로면 B2B가 +111%→+8%로 붕괴, B2B가 버텼다면 B2C가 정체. 그리고 B2B 감속은 이미 **2H2025 HoH -9.0% 역성장**에서 시작된 신호의 연장선일 가능성이 크다.

### 경영진 발언 검증 (FY2025 연차보고서, 2026.3.27)

> "The 2025 results reflect **a phase of deliberate investments** to capture long-term growth opportunities in K-Beauty and to strengthen our operating platform."
> "It is **vital** for the Group to **continue to invest in B2B expansion**... B2B expansion **will also improve overall profit margin** because of scale of economy... On the other hand, **the major, capex-heavy infrastructures have already been set in place**."
...
| | 내용 | 상태 |
|---|------|------|
| **(a)** | B2B 확장이 전체 마진을 **개선**한다 | **이미 반증** — ABW GPM 16.6%(Offline 9.3%)가 연결 GPM을 30.5→29.6%로 희석 |
| **(b)** | capex 무거운 인프라는 **이미 완료** | **1H2026이 첫 시험대** — 회사가 든 증익 사유("판관비가 매출보다 느리게 증가")와 앞뒤가 맞음 |

**모순**: 투자의 명분이 성장이었는데, 투자 직후 반기에 성장이 반토막. 회사 서사는 "B2B 가속"인데 숫자는 "B2B 감속". 게다가 이 경영진의 궤적 발언은 **50:50 B2B 비중**에서 이미 한 번 빗나감(확정 30:70 — 아래 §CFO 소통 내용).
...
## 0-B. 1H2026 확정 (2026-09-21, 8/28 중간보고서) — 꺾인 엔진은 ABW Online, 재진입 트리거 2/3

> 원본: `reports/YesAsia_InterimReport2026.pdf` (+ .txt). 7/27의 "8.28 판별 순서" 1~3번에 답한다.
> 한 줄: **매출 감속의 원인은 B2B 온라인(-13.4%)이고, 마진은 전 세그먼트에서 올랐다.** "마진을 깎아 사는 성장"이라는 손절 논리는 이 반기엔 반대로 움직였다.

| 항목 (US$M) | 1H2025 | **1H2026** | YoY |
|------|------:|------:|----:|
| 매출 | 244.6 | **301.5** | +23.2% (1H25 +49%) |
| 매출총이익 (GPM) | 73.3 (30.0%) | **94.0 (31.2%)** | +28.2% / **+1.2%p** |
| 영업이익 (OPM) | 18.7 (7.6%) | **24.3 (8.1%)** | **+30.1%** / +0.5%p |
| 순이익 (NPM) | 14.1 (5.8%) | 18.3 (6.1%) | +30.0% |
| 이익 전환율 (OP성장 ÷ 매출성장) | 0.5x(FY25) | **1.3x** | |

세그먼트 (US$M):

| | 매출 | YoY | 비중 | GPM | 전년 GPM | 세그먼트 이익(마진) |
|---|---:|---:|---:|---:|---:|---|
| YesStyle B2C | 215.1 | +30.5% | 71.3% | 35.0% | 35.4% | 20.3 (9.5%, 전년 9.7%) |
| **ABW Online** | **48.7** | **-13.4%** | 16.1% | **21.6%** | 20.0% | ABW 합산 8.3 (10.0%, 전년 9.9%) |
| ABW Offline | 34.0 | **+57.1%** | 11.3% | **22.8%** | 14.7% | |
| ABW 소계 | 82.8 | +6.2% | 27.4% | 22.1% | 18.6% | |

- **판별 1번(B2B와 Offline 비중)**: Offline만 준 게 아니라 **Online이 꺾였다** — 고객 수 4,100 → **2,800명(-31.7%)**, 객단가 +38.6%. 소형 바이어가 빠지고 대형 바이어로 집중. Offline은 오히려 +57%. 즉 "의도된 저마진 축소"가 아니라 **온라인 B2B의 동력 상실 + 오프라인 키채널이 그 자리를 메운 것.**
- **판별 2번(ABW Online GPM)**: 20.0 → 21.6% 개선 ✅. 한국 창고(마플트리 로봇창고, 2025.5) 효과로 운임비율 19.2 → 19.0%.
- **판별 3번(마케팅비율)**: 5.2 → **5.5%**(제품 시딩 $1.8M, 전시회 $0.9M) — 안 내려갔고 매출은 감속. ❌
- Offline GPM 14.7 → 22.8%(고마진 브랜드 믹스)로 **"Offline = 저마진"이라는 전제 자체가 이번 반기엔 성립 안 한다.** 관리비는 일회성 퇴직비용 $1.24M 빼면 매출비 10.9% 유지.

| 재진입 트리거 | 1H2026 | 판정 |
|---|---|:---:|
| ⓐ Online GPM 개선 | 20.0 → 21.6% | ✅ |
| ⓑ Offline 비중 둔화 | 8.9 → 11.3%(ABW 내 27.8 → 41.1%) | ❌ (전제 흔들림) |
| ⓒ OPM 반등 | 7.6 → 8.1% | ✅ |

**판정: 재진입 보류 유지(3개 동시 미충족) — 단 손절 논리의 일부는 반증됐다.** GPM·OPM이 동시에 올랐고 세그먼트 마진도 B2B가 올랐으니 "질(②) 탈락"의 근거였던 "GPM 4년 연속 하락"은 5년째에 멈췄다. 남은 문제는 성장 자체 — +49% → +23%로 반토막이고 그 원인이 B2B 온라인 고객 이탈(-32%)이라 구조적일 수 있다. 기본 시나리오(연 +15%, OPM 유지)는 1H가 상회(+23%, OPM 8.1%)해 기본 배수 1.45x → ~1.6x 여지. 주가 HK$3.49, 1H EPS 4.39¢ 연환산 기준 PER **~5x**. 다음 판별: 2H ABW Online 고객 수가 2,800에서 더 빠지는지 — 빠지면 B2B 플랫폼 논리 종결.

## 0. 3년 영업이익 배수 점검 (2026-07-05)

> 질문: **영업이익이 3년에 2배 되는가?** (투자판단모델.md — 연 ~26%)
> 기준 수익력: FY2025 영업이익 **$31.1M** (단, 2H 연환산 $25.7M — 궤적은 이미 감속) → 2배 목표 = FY2028 **~$62M**
> 포지션: **2026.06 전량 손절(-31.5%)** — 이 점검은 사후 검증 겸 재진입 판단용.
