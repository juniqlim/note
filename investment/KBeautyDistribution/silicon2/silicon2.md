...
## 0-A. 2Q26 리뷰 (2026-09-21, IR 8/13 + 반기보고서 8/14)

> 원본: `reports/silicon2_h1_2026/` (IR PDF, rcpNo 20260814003895)
> 한 줄: **분기 최대 실적(OPM 20.6%)에 감시 지표 셋은 통과, 재고 하나가 경고선을 넘었다.**

### 2Q26 실적 (연결, 억원)

| 항목 | 2Q26 | YoY | QoQ | 1H26 | YoY |
|------|-----:|----:|----:|-----:|----:|
| 매출 | **4,026** | +51.8% | +16.2% | 7,492 | +46.6% |
| 매출총이익 (GPM) | 1,290 (32.0%) | +47.7% | | 2,329 (31.1%) | |
| 판관비 (매출비) | 460 (11.4%) | +30.8% | | | |
| 영업이익 | **830** | **+59.0%** | +28.6% | **1,475** | +47.6% |
| OPM | **20.6%** | +0.9%p | +2.0%p | 19.7% | |
| 순이익 | 723 | +103% | | 1,267 | +70% |

- 2026E 컨센 OP 2,650억 대비 **1H 진행률 55.7%** — 2H를 1H 수준으로만 잡아도 ~3,000억. 기준 수익력 상향 대상.
- 판관비 안: 운반비 135억(+74%, 매출비 2.9→3.4% — 유가 상승 + 공급 안정용 선제 출하), 감가상각 43억(+105%, moida 매장), 광고선전비 48억(-5.5%). 지급수수료는 -20%.
- 지역 2Q: 유럽 1,734억(+61.6%, 비중 43.1%, QoQ +7.2%) / **북미 873억(+78.3%, QoQ +35.8% — "미국 정체"가 뒤집힘, Ulta 오프라인)** / 아시아 575(+28.7%) / 중동 260(-7.1%, 전쟁) / 중남미 244(+75.5%, 6월 멕시코 법인) / CIS 224(+75.7%).
- 브랜드(IR): 메디큐브·조선미녀·닥터엘시아 상위 지속 성장, COSRX 협업 재개 후 반등. 브랜드별 비중은 IR 이미지·반기보고서 모두 미공시.
- 자본: 2025.3 제3자배정 상환전환주 440만주가 **2026.4.24 전량 보통주 전환** — 발행주식 6,558만주(+7.2%), 부채(기타비유동 486억)가 자본으로 이동해 부채비율 55→40%.

### 감시 지표 4개 판정

| 지표 | 기준 | 2Q26 | 판정 |
|------|------|------|:---:|
| ⓐ OPM | 16% 위 유지 | **20.6%** (1Q 18.6 → 2Q 20.6) | ✅ |
| ⓑ 구다이(조선미녀) 이탈 | 유럽 확산 여부 | 조선미녀 상위 유지·성장(IR). 비중 수치는 미공시 | ✅(제한) |
| ⓒ 유럽 성장률 | 정체 진입 시점 | +61.6% (1Q +137%에서 감속, QoQ +7%). 북미 +78%가 바통 | ⚠️ |
| ⓓ 재고/매출 | 27% 초과 시 경고 | 재고 **4,510억**(2025말 3,001억, +50%; 1Q 대비 +33%). TTM 매출 1조 3,488억 대비 **33.4%** | ❌ |

- ⓓ 해설: 회사 설명은 "지정학 영향 공급단가 인상에 대비한 전략적 재고 확대 + 매입채무 상환(-20%)". 그런데 매입채무는 56억→614억으로 **늘었다**(외상 매입 확대). 재고 +50%가 매출 +47%를 살짝 앞서는 수준이라 채널 적체로 단정은 못 하나, 2025말 26.9%에서 한 반기 만에 33%는 회전(약 180일)이 더 나빠진 것. **3Q 재고 QoQ가 판별** — 전략 비축이면 3Q에 줄고, 적체면 더 는다.
- 현금흐름 1H26: OCF **+135억**(1H25 -313억) / CapEx 320억(moida, 1H25 37억) → FCF ≈ **-185억**. 4번째 기간 연속 FCF ≤ 0 — ① 판정 "약~중" 유지.

### 판정

**보유 유지 — 성장 관문은 경계선 그대로, 재고 경고 1개 점등.** 기준 수익력을 ~3,000억으로 올리면 2배 목표도 6,000억으로 올라 기본 배수는 1.55x → **~1.4~1.5x**(2026E 매출 1.55조 × +20/15/10% × OPM 18% = 2029 ~4,200억)로 오히려 내려간다 — "이미 산 성장" 효과. 주가 40,750(9/21), 시총 2.67조, PER(1H 순이익 연환산) **~10.5x**로 ④ 여유 통과 유지. 판별점: **3Q 재고 방향(ⓓ) + 북미 재가속 지속 여부**. ⓓ가 3Q에도 오르면 보수(1.05x) 경로 재배정.
