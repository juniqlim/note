...
> 한 줄: **매출은 크게 이겼고 마진은 졌다.** 물류비가 GPM을 최고치로 밀어올린 만큼을 광고비가 판관비에서 도로 가져갔다.

### 2Q26 실적 (연결, 억원)

| 항목 | 2Q26 | YoY | QoQ | 하나 프리뷰(7/2) | 차이 |
|------|------|-----|-----|-----------------|------|
| 매출 | **7,703** | +39.3% | +7.8% | ~7,160 | **+7.6%** |
| 매출총이익 | 3,705 | +45.0% | +22.3% | - | - |
| GPM | **48.1%** | +1.9%p | +5.7%p | - | 분기 최고 |
| 영업이익 | **1,762** | +46.7% | -0.5% | 1,776 | -0.8% |
| OPM | 22.9% | +1.2%p | -1.9%p | 24.8% | **-1.9%p** |
| 지배순이익 | 1,372 | - | - | - | - |
...
- 반대편에서 **광고선전비가 74% 급증**(2Q26 단독 403억, 2Q25 229억). 7월 노트에서 우려했던 "2Q 월드컵 광판비"가 실제로 집행됐다. GPM +5.7%p QoQ가 판관비율 상승으로 상쇄돼 OPM은 오히려 -1.9%p QoQ.
...
- 2026-04 공모사채 **2,000억 발행**(무보증 2-2, 4.06%) + 상반기 영업CF 2,683억으로 현금 6,306억 확보. 단기금융자산까지 포함하면 실질 순현금 **1,475억**.
...
- 감시 추가: **광고선전비 정상화 여부**(2Q 403억이 월드컵 일회성인지 — 3Q OPM이 답), **물류비 하향 지속성**(GPM 48.1%의 3.0%p가 여기서 나옴), **중국 현지 판가·물량**(부문 OPM 말고).
...
| 중국 자싱공장 | 건설 중 | - | **2,072억 / 8라인 / 2027.1 완공**(2025.11 정정공시), +11.3억식 |
...
- [ ] **광고선전비 정상화 여부**: 2Q26 단독 403억(2Q25 229억). 월드컵 일회성이면 3Q OPM 회복
...
- [ ] **2Q26 리뷰 리포트 다운 + 컨센 갱신** → 매출 상회·마진 미달에 대한 증권사 해석 확인
...
*최초 작성: 2026-03-05 / 갱신: 2026-08-18 (2Q26 반기보고서 반영 — 지역별 손익 분해, 순현금 전환, CAPA·가동률, 에스앤디 동시 점검).*
