...
## 2Q26 갱신 (2026-09-21, DART 반기 재무 API)

| 항목 (억원) | 2Q26 | 2Q25 | 1H26 | 1H25 |
|---|---:|---:|---:|---:|
| 영업이익 | **449** | 340 (+32%) | 806 | 516 (+56%) |
| 당기순이익 | **77** | -52 (흑전) | 139 | -75 |
| 영업활동현금흐름 | | | 351 | -534 |

- 본업 정상화(1Q +104% → 2Q +32%)는 지속. 순차입은 그대로: 단기차입·사채 1.58조 + 장기 0.33조 − 현금 1,752억 ≈ **1.73조**, 부채비율 337%.
- 시총 7,694억(주가 53,400, 4월 고점 68,600 대비 -22%). AIDC 마일스톤(수전·테넌트 계약)은 반기보고서 범위 밖 — 미확인. 투자 논리(옵션 가치)엔 변화 없음.
