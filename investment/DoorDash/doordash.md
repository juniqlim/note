...
## 0-A. Q2'26 리뷰 (2026-09-21, 8-K 8/5) — 마진 인플렉션이 멈췄다

> 원본: `report/8K_Q2_2026_press_release.txt`
> 한 줄: **매출 +36%에 GAAP 영업이익은 -4%.** 정찰의 목적(마진 인플렉션 검증)에 반대 신호가 나왔고, 손절 조건으로 적어둔 "재분류 비용 현실화"가 $98M으로 숫자가 됐다.

| 항목 | Q2'25 | **Q2'26** | YoY |
|------|------:|------:|----:|
| Marketplace GOV | $24.2B | **$33.1B** | +36% (**Deliveroo 제외 +23%**) |
| 총주문 | | 970M | +27% (제외 +17%) |
| 매출 | $3,284M | **$4,500M** | +36% (제외 +24%) |
| Net Revenue Margin | 13.5% | 13.5% | 0 |
| 영업이익(GAAP) | $163M | **$156M** | **-4%** |
| OPM | 5.0% | **3.5%** | -1.5%p |
| 순이익 | $285M | $200M | -30% |
| Adj. EBITDA | $653M | $914M | +40% (GOV의 2.8%) |
| FCF | $355M | $742M | +109% |
| SBC | | $349M | FY $1.2~1.3B |
| 법률·세무·규제 비용 | | **$98M** | 근로자 분류 소송비 + 판매세 충당 |

- Deliveroo: GOV·MAU·주문 성장 가속, "이익 기대 상회" — **흑자 여부는 미공시**.
- 미국 레스토랑 GOV 소폭 가속(DashPass 회원 12개월 순증이 이전 24개월 합계 초과), 식료품·리테일 고성장 + 단위경제 개선.
- Q3 가이드: GOV $33.0~34.0B(**QoQ 정체**), Adj. EBITDA $950~1,100M.

| 승격 트리거 | 기준 | Q2'26 | 판정 |
|---|---|---|:---:|
| ⓐ GOV 유기 25%+ 또는 볼륨 주도 | | 유기 +23%, 주문 +17% (가격·믹스 주도) | ❌ |
| ⓑ Deliveroo 흑자 | | 미공시("기대 상회") | ➖ |
| ⓒ fPER 30 | | 시총 ~$83B / GAAP OI 런레이트 ~$0.7B = **100x+** | ❌ |
| 손절 조건: 재분류 비용 현실화 | 보수 시나리오 | **$98M**(분기 OI의 63%) | ⚠️ 점등 |

**판정: 정찰 목적 약화 — 정찰 정리 검토(사용자 결정).** 기준 수익력 FY26E $1.3B(OPM 7.5%)는 1H 페이스로 달성 불가 — 2Q OPM 3.5%, 규제비 제외해도 5.6%다. Adj. EBITDA +40%·FCF 2배는 살아 있지만 이 모델은 GAAP 영업이익으로 자르고, 그 라인이 매출 +36% 구간에서 감소했다는 게 핵심이다. 기본(1.85x)은 OPM 9% 도달을 가정하는데 방향이 반대. 주가 $192.94(정찰 -26.9%). 남길 이유가 있다면 Deliveroo 흑자 공시 + 규제비 소멸 두 개가 3Q에 동시에 나올 때뿐.
