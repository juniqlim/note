...
2027 HBM 재계약. **7/29 컨콜은 물량만 확정하고 가격을 열지 않아 판정이 이월됐다.** 볼 것 셋:

1. **가격 수준**이 목표주가들의 전제(2027 HBM **+76~100%**)를 지키는가 → [C]
2. **cap 없는 구조**(3사 중 하이닉스만)가 실제 인상으로 이어지는가 → [C]
...
> **판정 결과 (7/29)**: 컨콜은 2027 HBM **가격을 열지 않았다.** 물량·이행만 확정 → **판정 미완, 4Q26으로 이월.**
...
- **LTA**: 핵심 고객 포함 **10여개 협상 마무리**, 통상 **5년**, **예치금 등 재무적 장치 포함**, 가격은 *"변동성 대응 가능하도록 설계"*, *"하방 안정성과 유연성을 균형 있게"*
- **커버리지·가격 구성은 "영업기밀"로 비공개**
- 캐펙스 **올해 40조원 후반대**. M15X·용인 가속, 용인 1기 클린룸 2027년 초
- *"생산능력 확대가 공급 과잉으로 직결되지 않는다"*
- 하반기 HBM4 판매 본격화 → 출하·ASP 동반 개선. NAND 321단 연말 국내 캐파 50%
- 주주환원: *"현금 창출력이 크게 강화된 만큼 의미 있게 확대 가능"*, 구체안은 **연내 별도 발표**(ADR 규제)
