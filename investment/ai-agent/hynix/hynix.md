...
**③ 계약 조건 비교 — 경쟁사는 가격 하단을 잠갔고, 1위는 안 잠갔다**

| | **마이크론 SCA** | **하이닉스 LTA** |
|---|---|---|
| 고객 수 | **16개** | 10여개 |
| 기간 | **2026~2030 (5년 고정)** | 통상 5년 |
| 재무 장치 | $22B 약정, **현금 예치금 $18B** | 예치금 포함(규모 미공개) |
| **가격 구조** | **최소 보장가(floor)를 "과거 호황기 정점보다 높은 수준"으로 설정** | **"변동성 대응 가능하도록 설계"** — floor 언급 없음 |

- **이것이 §0 판정("물량은 잠갔고 가격은 안 열렸다")의 진짜 무게다.** 물량 락업은 양사 공통이고, 갈리는 것은 **가격 하단의 유무**다. 다운사이클이 오면 **floor가 있는 쪽이 덜 빠진다.**
- 노트의 핵심 질문(**다운사이클 진폭이 시장 가정보다 작은가**)에 이것은 **하이닉스에 불리한 재료**다. 진폭을 줄이는 장치를 경쟁사가 먼저, 더 강하게 걸었다.
- **§0 조건②("가격결정권 미입증")를 재확인한다**: HBM 출하량 점유율 62%인 1위가, 21% 사업자보다 **약한 가격 조건**을 받았다. 점유율이 곧 가격결정권이 아니라는 증거이자, "임차한 힘" 진단의 보강.
- 참고 단가: HBM3E 12단 하이닉스-엔비디아 약 **$440**, HBM4 **$590~600** 수준으로 알려짐. 시장 규모는 2026년 **$54B+** 전망.
- **4Q26 재계약에서 볼 것이 하나 늘었다**: 가격 수준(+76~100%)뿐 아니라 **floor 조항을 받아내는가**. 받아내면 다운사이클 진폭 가정 자체를 낮출 근거가 되고, 못 받아내면 1위 프리미엄의 실체를 다시 물어야 한다.
