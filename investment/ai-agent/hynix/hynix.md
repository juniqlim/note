...
**지표 주의**: FCF (Free Cash Flow) = NI + D&A - 총 CapEx. OE (Owner Earnings) ≈ NI + D&A - 유지 CapEx ≈ NI (정상 상태). **OE > FCF**, 차이 = 성장 CapEx. 13-3 OE 180조는 FCF로 환산 시 ~160조.

### 13.2 할인율별 내재가치 (주당, 만원)
...
**2026-02-09 ~ 2/24 (13~13-2)**: 시나리오 A·B 분리하고 확률 75:25 가중. CapEx 가정 변경에 따라 13-1·13-2 분기.

### 13.4 방법론 차이

| | 13~13-2 (2/9, 2/24) | 13-3 (5/12) |
|---|---|---|
| 추정 기간 | 10년 | 10년 |
